...
function loadPointDD(line, numPoints){
	...
	for(var i = 0; i < numPoints; i++) {
        ...
        newOption.text = "Point: " + line.pointList[i].name;
		newOption.value = i;
...
$(function(){
	...
	$('#pointList').change(function () {
		//TODO: Does this do exactly what we want? I have no idea. May need to change
		clearTable();
	...
	$('#lineList').change(function () {
		//TODO: Add functionality to adding lines
		var optionSelected = $(this).find("option:selected");
